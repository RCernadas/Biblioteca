...
public class Bibliotecario implements BibliotecarioInterfaz {
	...
	public void prestarDocumento(String dni) {
		if (documentoActual != null) {
			...
			System.out.println("Se ha devuelto el documento actual: "+getDocumentoActual() +" a: -> " + usuario.getDni() );
	...
	public void devolverDocumento(String dni) {
		if (documentoActual != null) {
			Usuario usuario = Consultas.DevolverDocumentoActual(documentoActual , dni);
			System.out.println("Se ha prestado el documento actual: "+getDocumentoActual() +" a: -> " + usuario.getDni() );
			documentoActual = null;
		}else System.out.println("No se ha podido devolver el documento porque no has seleccionado ningun documento");
